...
static void Nvic_CoreVectTableInit( void )
{
    ...
    nvic_IrqVectTable.CoreIrq[ NVIC_CORE_IRQ_SEC_HARDFAULT    ] = Nvic_HardFault_DefaultHandler;
    nvic_IrqVectTable.CoreIrq[ NVIC_CORE_IRQ_NONSEC_HARDFAULT ] = Nvic_HardFault_DefaultHandler;
